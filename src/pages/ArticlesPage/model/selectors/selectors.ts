...
import { ArticlesSortField } from '../types/articlesPageSchema';
...
export const getArticlesPageSortField = (state: StateSchema) => state.articles?.sortField || ArticlesSortField.DATE;
